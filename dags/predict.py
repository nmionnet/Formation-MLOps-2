...
from dags.config import DATA_FOLDER, GENERATED_DATA_PATH, MODEL_PATH, MONITORING_TABLE_NAME, PREDICTIONS_FOLDER, SHADOW_MODEL_PATH, SHADOW_PREDICTIONS_FOLDER
...
def predict():
    ...
    def shadow_production_with_io_task(feature_path: str) -> None:
        shadow_predict_with_io(features_path=feature_path,
                        ...
                        predictions_folder=SHADOW_PREDICTIONS_FOLDER)
